...
onready var HP_label = $Background/HBoxContainer/BarContainer/HealthBar/Variable_Value
onready var HP_bar = $Background/HBoxContainer/BarContainer/HealthBar/TextureProgress
onready var TP_label = $Background/HBoxContainer/BarContainer/ThirstBar/Variable_Value
onready var TP_bar = $Background/HBoxContainer/BarContainer/ThirstBar/TextureProgress
onready var EP_label = $Background/HBoxContainer/BarContainer/EnergyBar/Variable_Value
onready var EP_bar = $Background/HBoxContainer/BarContainer/EnergyBar/TextureProgress
